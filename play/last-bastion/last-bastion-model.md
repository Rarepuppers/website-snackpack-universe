...
| --- | --- | --- |
| Map | Starchart, schema-v3 persistence, node wiring, and depth-budgeted encounters live | Task 49 full-route tuning |
...
| Waves/rounds | Ten-wave Quick Drop plus depth-budgeted multi-wave expedition encounters | Complete through Task 48; Task 49 tuning remains |
...
Sequencing note: Tasks 44–48 are complete. **Next recommended implementation: Task 49, Campaign tuning pass — the 20-node difficulty curve.** The Corrupted Human family (Batch M) and sector campaign stay deferred until the single-sector MVP succeeds.
