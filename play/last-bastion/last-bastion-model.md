...
62. **Corrupted Human family completion gate. In progress 22 July 2026.** The Abomination is live in `?scenario=abomination`: it locks a target through a persistent 0.9-second nested-ring/cardinal-bracket slam tell, commits one 1.55 m impact, damages nearby numeric-durability terrain, holds a 1.35-second vulnerable recovery, and enforces a repeat cooldown. Its shamble, attack, and recovery phases use all three Batch M body rows. Stationary-hit, perpendicular-dodge, single-impact, recovery, and terrain-source tests are live; Full HD and 4K browser review found exact scaling and no warnings. Next add off-screen warning coverage for ranged Marines, then tune mixed Survivor/Marine/Abomination pulses before normal Quick Drop or expedition promotion. Keep Abomination Prime deferred.
