...
58. **Survivor movement gate.** Add sprint stamina, acceleration/deceleration, swarm steering, and controller dead-zone rules without allowing crowd rings or route sealing; test at 960×540 simulation space and 1920×1080 / 3840×2160 presentation scales.
59. **Marine telegraph gate.** Lock telegraph → slow knife projectile → cover/player impact → recovery/cooldown, with damage-source telemetry and deterministic dodge windows.
...
Sequencing note: Tasks 44–50 and 53–57 are complete. **Next: Task 58, survivor movement, followed by Task 59.** Tasks 60–61 are cross-cutting release gates and may advance alongside content once the single-sector MVP succeeds. Keep the Corrupted Human family (Batch M) and sector campaign deferred until then.
