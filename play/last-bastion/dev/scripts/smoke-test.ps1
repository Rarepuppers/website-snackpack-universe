...
try {
  ...
  $reviewRoutes = @(
    ...
    '/play/last-bastion/?mode=gallery&batch=elite-e1-ui',
    '/play/last-bastion/?mode=gallery&batch=boss-b2-b3',
    ...
    '/play/last-bastion/?scenario=the-choir&loadout=vertical',
    '/play/last-bastion/?scenario=foundry-sovereign&loadout=vertical',
