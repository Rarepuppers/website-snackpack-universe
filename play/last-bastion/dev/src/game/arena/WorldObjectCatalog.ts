...
export const WORLD_OBJECT_CATALOG: readonly WorldObjectDefinition[] = Object.freeze([
  ...
  { id: "gate-button", name: "Gate Button", role: "interactable", themes: all("bastion", "starship", "containment"), blocksMovement: false, blocksProjectiles: false, durability: null, footprintMetres: size(0.7, 0.7), interaction: { seconds: 0.75, effect: { type: "open-gate" } }, maxPerRoom: 2, placement: "objective-anchor" },
