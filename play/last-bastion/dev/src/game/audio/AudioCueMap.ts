...
const CUES: Readonly<Partial<Record<CombatEvent["type"], AudioCue>>> = Object.freeze({
  ...
  "player-shield-hit": cue("player-shield-hit", 780, 0.1, 0.08, "square", 420),
  ...
  "infected-survivor-rush": cue("survivor-rush", 220, 0.3, 0.1, "sawtooth", 420),
  "abomination-recovery": cue("abomination-recovery", 300, 0.18, 0.06, "triangle", 180),
  ...
  "choir-voice-collapsed": cue("choir-collapse", 520, 0.32, 0.1, "sine", 180),
  "choir-merged": cue("choir-merge", 180, 0.55, 0.12, "sawtooth", 720),
  "choir-pulse-warning": cue("choir-warning", 640, 0.24, 0.07, "sine", 920),
  "choir-pulse": cue("choir-pulse", 140, 0.34, 0.12, "triangle", 55),
  "choir-flood-hit": cue("choir-flood", 110, 0.14, 0.07, "sine", 70),
  "sovereign-fabrication-warning": cue("sovereign-warning", 320, 0.28, 0.08, "square", 620),
  "sovereign-fabricated": cue("sovereign-fabricated", 220, 0.34, 0.11, "square", 760),
...
const WEAPON_CUES: Readonly<Record<WeaponId, AudioCue>> = Object.freeze({
  ...
  "auxiliary-drone": cue("auxiliary-drone-shot", 1180, 0.07, 0.05, "sine", 760),
});
