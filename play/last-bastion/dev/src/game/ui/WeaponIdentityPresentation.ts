...
export const WEAPON_IDENTITY_PRESENTATIONS: Readonly<Record<WeaponId, WeaponIdentityPresentation>> = Object.freeze({
  ...
  "marauder-ar": { weaponId: "marauder-ar", silhouetteId: "assault-rifle", tileFrame: 7, colour: 0xff9a52, effectStyle: "projectile", dedicatedAssetId: "marauder-ar-v1" },
  ...
  emberlance: { weaponId: "emberlance", silhouetteId: "emberlance", tileFrame: 3, colour: 0xff5148, effectStyle: "explosive", dedicatedAssetId: null },
  "storm-coil-beam": { weaponId: "storm-coil-beam", silhouetteId: "storm-coil", tileFrame: 0, colour: 0x68e4e8, effectStyle: "beam", dedicatedAssetId: null },
  "blight-scythe": { weaponId: "blight-scythe", silhouetteId: "blight-scythe", tileFrame: 1, colour: 0x7ed957, effectStyle: "melee", dedicatedAssetId: null },
  ...
  "auxiliary-drone": { weaponId: "auxiliary-drone", silhouetteId: "auxiliary-drone", tileFrame: 4, colour: 0x68e4e8, effectStyle: "projectile", dedicatedAssetId: null },
});
