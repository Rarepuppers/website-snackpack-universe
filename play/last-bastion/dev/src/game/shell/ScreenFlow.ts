...
export const LAB_ROUTES: readonly LabRoute[] = Object.freeze([
  ...
  { label: "Ironhide Abomination elite", url: "?scenario=ironhide-abomination&loadout=vertical" },
  { label: "Splitcaller Weaver elite", url: "?scenario=splitcaller-weaver&loadout=vertical" },
  { label: "Voltaic Warden elite", url: "?scenario=voltaic-warden&loadout=vertical" },
