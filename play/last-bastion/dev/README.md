...
- `/play/last-bastion/?scenario=corrupted-human&loadout=vertical` — Task 62 mixed-family pressure lab with six Survivors, two Marines, one Abomination, and an off-screen ranged-warning check
- `/play/last-bastion/?scenario=nest-weaver&loadout=vertical` — Task 63 behavior gate: locked egg placement, exposed recovery, destructible six-second pod countdown, reservation caps, and non-recursive hatchlings
- `/play/last-bastion/?mode=gallery&batch=t` — Batch T production review: all 32 directional/state Weaver frames, six pod lifecycle states, and eight onset/dissipate event effects
- `/play/last-bastion/?scenario=storm-savant&loadout=vertical` — Task 64 code-first gate: deterministic conductive nodes, cover-clipped fixed lightning rails, destructible interruption, escape-lane validation, and overload recovery
- `/play/last-bastion/?scenario=scrap-skitterer&loadout=vertical` — Task 65 code-first machine gate: eight-unit cap, locked rush lanes, cover/player braking, Shock weakness, and visible harmless wrecks
- `/play/last-bastion/?scenario=arc-warden&loadout=vertical` — Task 65 ranged-machine gate: two-unit cap, fixed narrow beam lanes, first-cover endpoints, Shock weakness, one discharge, and punishable recovery
- `/play/last-bastion/?scenario=cyborg-reclaimer&loadout=vertical` — Task 65 support-machine gate: finite repair patches, one interruptible tether, damaged-machine targeting, mixed-family pressure, and no boss/self repair
- `/play/last-bastion/?scenario=foundry-fabricator&loadout=scattergun&autofire=0` — Task 65 machine-summoner gate: destructible reserved pads, timed non-recursive drone/turret children, owner cleanup, and a fixed code-native turret warning lane
- `/play/last-bastion/?scenario=synapse-herald&loadout=scattergun&autofire=0` — Task 66A mini-boss gate: three locked danger zones, a two-step lunge chain that gains one final-frenzy step, and one breakable Brain Blob damage-sharing link
...
- `/play/last-bastion/?scenario=the-choir&loadout=vertical` — shared-health three-voice finale; voice collapse, merge pulse, and shrinking safe-space lab
- `/play/last-bastion/?scenario=foundry-sovereign&loadout=vertical` — stationary shock-weak command core with escalating drone/turret fabrication lab
...
- `/play/last-bastion/?mode=gallery&batch=boss-b2-b3` — Choir and Foundry Sovereign bodies, mechanic accents, and portraits
...
- `/play/last-bastion/?mode=gallery&batch=elite-e1-ui` — four elemental upgrade tiles plus Razorlord dash and Blightspitter puddle effect accents
