...
**Status:** Generated, normalized, and gallery-bound — 22 July 2026; live-theme acceptance pending.
...
Code owns room layout, collision, cover, destructibility, inventory, shop state, healing, interaction, objectives, hazards, lighting, animation, and timing. Review at `?mode=gallery&batch=ae` before live theme promotion.
