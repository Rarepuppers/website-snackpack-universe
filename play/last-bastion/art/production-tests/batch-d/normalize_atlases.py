"""Normalize approved Production Batch D1 masters into fixed Phaser assets."""
...
fitted_sheet(
    "brood-warden-spritesheet-v1.png",
...
fitted_sheet(
    "brood-warden-effect-atlas-v1.png",
