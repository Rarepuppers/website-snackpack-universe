...
def main():
 specs=[("machine-foundry-fabricator-v1",4,9,192),("machine-foundry-pad-v1",6,1,128),("machine-foundry-drone-v1",4,7,128),("machine-foundry-turret-v1",4,8,128),("machine-foundry-effects-v1",4,2,128)]; results=[]
 ...
 sheet=Image.new("RGB",(1400,7600),(18,22,28)); draw=ImageDraw.Draw(sheet)
 ...
 draw.text((48,36),"FOUNDRY FABRICATOR / BODY + PAD + DRONE + TURRET + EFFECTS / 4K PREFLIGHT",fill=(240,244,248),font=font); y=110
 for n,im in results:
 ...
 draw.text((48,7520),"Art supports the authorized Fabricator package; charges, pad interruption, child ownership, turret tells, cover blocking, timing, and collision remain code-owned.",fill=(178,186,196),font=small); sheet.save(ROOT/"foundry-fabricator-contact-sheet.jpg",quality=95,optimize=True)
