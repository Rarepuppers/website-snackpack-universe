"""Build the deterministic Batch 68A weapon-tile atlas from retained sources."""
...
def main() -> None:
    ...
    png_path = ROOT / "weapon-identity-atlas-68a-v1-128.png"
    atlas.save(png_path, optimize=True)
    atlas.save(
        ROOT / "weapon-identity-atlas-68a-v1-128.webp",
        format="WEBP",
        lossless=True,
        method=6,
    )
