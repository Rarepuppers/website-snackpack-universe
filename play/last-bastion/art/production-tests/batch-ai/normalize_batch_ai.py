"""Build deterministic Batch AI Starship, Void, and Transit atlases and QA sheets."""
...
def main():
    ...
    draw.text((24, 18), "BATCH AI - STARSHIP / VOID / TRANSIT / 4K MASTER PREFLIGHT", fill=(231, 240, 246, 255))
    ...
    draw.text((850, 900), "Ship decks / airlock / bridge / void platform / teleporter / stargate / derelict", fill=(184, 202, 216, 255))
    draw.text((850, 930), "Room selection, collision, hazards, vacuum, interaction, and objectives remain code-owned.", fill=(184, 202, 216, 255))
    canvas.convert("RGB").save(ROOT / "batch-ai-contact-sheet.png", optimize=True)
    ...
    print("Wrote Batch AI masters, runtime atlases, seam mosaic, and contact sheet")
