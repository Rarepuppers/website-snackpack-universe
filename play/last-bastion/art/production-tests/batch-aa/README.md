# Assembly Prime production package - Batch AA

- `assembly-prime-v1`: 4x11 directional/state sheet, 44 frames at 192x192.
- `assembly-prime-pad-v1`: six stable reinforced command-pad states at 128x128.
- `assembly-prime-effects-v1`: four local event families x onset/dissipate, eight frames at 128x128.
- `assembly-prime-portrait-v1`: one 256x256 dossier portrait.
