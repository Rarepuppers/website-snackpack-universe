"""Build deterministic Batch AJ Containment and Underworld atlases and QA sheets."""
...
def main():
    ...
    draw.text((24, 18), "BATCH AJ - CONTAINMENT / UNDERWORLD / 4K MASTER PREFLIGHT", fill=(231, 240, 246, 255))
    ...
    draw.text((850, 900), "Prison / quarantine / containment / bunker / dungeon / ritual / infernal facility", fill=(184, 202, 216, 255))
    draw.text((850, 930), "Room selection, collision, hazards, interaction, and objectives remain code-owned.", fill=(184, 202, 216, 255))
    canvas.convert("RGB").save(ROOT / "batch-aj-contact-sheet.png", optimize=True)
    ...
    print("Wrote Batch AJ masters, runtime atlases, seam mosaic, and contact sheet")
