...
PARTS = {
    "robotics-support-v1": "ROBOTICS / SUPPORT",
    "water-treatment-v1": "WATER / TREATMENT",
    "expedition-field-gear-v1": "EXPEDITION / FIELD GEAR",
}
...
def contact_sheet(masters):
    ...
    draw.text((48, 36), "OBJECT BATCH O28 / ROBOTICS SUPPORT + WATER TREATMENT + EXPEDITION FIELD GEAR / 4K PREFLIGHT", fill=(240, 244, 248), font=font)
    y = 110
    for name, image in masters.items():
        ...
        y += 1110
    draw.text((48, 3440), "Robotics-support, water-treatment, and expedition-field-gear candidates; no interaction, collision, hazards, targets, telegraphs, or gameplay values baked in.", fill=(178, 186, 196), font=small)
    return sheet
...
def main():
    ...
    contact_sheet(masters).save(ROOT / "object-batch-o28-contact-sheet.jpg", quality=95, optimize=True)
