"""Build deterministic Batch AG Alien Hive atlases and QA sheets."""
...
def main():
    ...
    draw.text((24, 18), "BATCH AG - ALIEN HIVE AND INFESTATION / 4K MASTER PREFLIGHT", fill=(231, 240, 246, 255))
    ...
    draw.text((850, 900), "Nest / slime / nursery / eggs / hatchery / spores / feeding / queen / organic ship", fill=(184, 202, 216, 255))
    draw.text((850, 930), "Collision, hazards, spawning, interaction, animation, glow, and objectives remain code-owned.", fill=(184, 202, 216, 255))
    canvas.convert("RGB").save(ROOT / "batch-ag-contact-sheet.png", optimize=True)
    ...
    print("Wrote Batch AG masters, runtime atlases, seam mosaic, and contact sheet")
