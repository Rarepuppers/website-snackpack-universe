"""Build deterministic Batch AH Surface Frontier atlases and QA sheets."""
...
def main():
    ...
    draw.text((24, 18), "BATCH AH - SURFACE AND PLANETARY FRONTIERS / 4K MASTER PREFLIGHT", fill=(231, 240, 246, 255))
    ...
    draw.text((850, 900), "Earth / hostile planet / war-torn / grass / mud / crystal / blast zone", fill=(184, 202, 216, 255))
    draw.text((850, 930), "Biome row selection, collision, hazards, weather, interaction, and objectives remain code-owned.", fill=(184, 202, 216, 255))
    canvas.convert("RGB").save(ROOT / "batch-ah-contact-sheet.png", optimize=True)
    ...
    print("Wrote Batch AH masters, runtime atlases, seam mosaic, and contact sheet")
