"""Extract Emberfall magenta-key masters and emit fixed runtime atlases."""
...
def main() -> None:
    pairs = [
        ("emberfall-floor-atlas-v1-chroma.png", "emberfall-floor-atlas-v1.png"),
        ("emberfall-boundary-atlas-v1-chroma.png", "emberfall-boundary-atlas-v1.png"),
        ("emberfall-obstacle-atlas-v1-chroma.png", "emberfall-obstacle-atlas-v1.png"),
        ("emberfall-decal-atlas-v1-chroma.png", "emberfall-decal-atlas-v1.png"),
    ]
    for source, output in pairs:
        extract(source, output)
    grid("emberfall-floor-atlas-v1.png", "emberfall-floor-atlas-v1-64.png", 3, 2, 64, 2)
    grid("emberfall-boundary-atlas-v1.png", "emberfall-boundary-atlas-v1-64.png", 4, 2, 64, 1)
    grid("emberfall-obstacle-atlas-v1.png", "emberfall-obstacle-atlas-v1-96.png", 2, 2, 96, 2)
    grid("emberfall-decal-atlas-v1.png", "emberfall-decal-atlas-v1-64.png", 3, 2, 64, 4)
    print("Wrote Emberfall transparent masters and runtime atlases")
