"""Extract arctic-relay magenta-key masters and emit fixed runtime atlases."""
...
def main() -> None:
    pairs = [
        ("arctic-relay-floor-atlas-v1-chroma.png", "arctic-relay-floor-atlas-v1.png"),
        ("arctic-relay-boundary-atlas-v1-chroma.png", "arctic-relay-boundary-atlas-v1.png"),
        ("arctic-relay-obstacle-atlas-v1-chroma.png", "arctic-relay-obstacle-atlas-v1.png"),
        ("arctic-relay-decal-atlas-v1-chroma.png", "arctic-relay-decal-atlas-v1.png"),
    ]
    for source, output in pairs:
        extract(source, output)
    grid("arctic-relay-floor-atlas-v1.png", "arctic-relay-floor-atlas-v1-64.png", 3, 2, 64, 2)
    grid("arctic-relay-boundary-atlas-v1.png", "arctic-relay-boundary-atlas-v1-64.png", 4, 2, 64, 1)
    grid("arctic-relay-obstacle-atlas-v1.png", "arctic-relay-obstacle-atlas-v1-96.png", 2, 2, 96, 2)
    grid("arctic-relay-decal-atlas-v1.png", "arctic-relay-decal-atlas-v1-64.png", 3, 2, 64, 4)
    print("Wrote arctic-relay transparent masters and runtime atlases")
