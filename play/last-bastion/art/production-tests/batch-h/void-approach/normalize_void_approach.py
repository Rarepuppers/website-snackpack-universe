"""Extract void-approach magenta-key masters and emit fixed runtime atlases."""
...
def main() -> None:
    pairs = [
        ("void-approach-floor-atlas-v1-chroma.png", "void-approach-floor-atlas-v1.png"),
        ("void-approach-boundary-atlas-v1-chroma.png", "void-approach-boundary-atlas-v1.png"),
        ("void-approach-obstacle-atlas-v1-chroma.png", "void-approach-obstacle-atlas-v1.png"),
        ("void-approach-decal-atlas-v1-chroma.png", "void-approach-decal-atlas-v1.png"),
    ]
    for source, output in pairs:
        extract(source, output)
    grid("void-approach-floor-atlas-v1.png", "void-approach-floor-atlas-v1-64.png", 3, 2, 64, 2)
    grid("void-approach-boundary-atlas-v1.png", "void-approach-boundary-atlas-v1-64.png", 4, 2, 64, 1)
    grid("void-approach-obstacle-atlas-v1.png", "void-approach-obstacle-atlas-v1-96.png", 2, 2, 96, 2)
    grid("void-approach-decal-atlas-v1.png", "void-approach-decal-atlas-v1-64.png", 3, 2, 64, 4)
    print("Wrote void-approach transparent masters and runtime atlases")
