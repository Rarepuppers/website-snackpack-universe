// Shared FreeCell solver engine for the WEBSITE build.
// Uses the exact rand()/deal() from play/freecell/index.html so results apply
// to the deals the page actually serves. Required by verify-freecell-deals.js
// (checks the shipped pool) and gen-freecell-seeds.js (scans for new deals).
// Keep rand()/deal() byte-identical to the page or the pool becomes meaningless.
